...
1. Text Slide with background image:
   Use for key facts, rules, or visually-supported concepts. Always include "visualKeywords" — 2-4 English keywords for a relevant background photo.
   {
     "type": "text",
     "content": {
   ...
   Use for supervisor-worker scenarios, safety briefings, or demonstrating correct behavior on site. The dialogueLines are performed by two AI avatars.
   {
     ...
     "content": {
       ...
       "dialogueLines": [
         ...
         { "character": "Supervisor", "text": "Good. Proceed safely." }
       ]
     }
   }
...
7. Quiz Slide (knowledge check):
   Use to test understanding of a rule or procedure just covered.
   {
     "type": "quiz",
     "content": {
       "heading": "What protects from falls?",
       "options": ["Safety harness", "Hard hat", "Safety glasses"],
       "correctIndex": 0,
