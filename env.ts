...
export const env = createEnv({
  server: {
    ...
    HEYGEN_INSTRUCTOR_AVATAR_LOOK_ID: z.string().optional(),
    HEYGEN_STUDENT_AVATAR_LOOK_ID: z.string().optional(),
  },
  client: {
  ...
  runtimeEnv: {
    ...
    HEYGEN_INSTRUCTOR_AVATAR_LOOK_ID: process.env.HEYGEN_INSTRUCTOR_AVATAR_LOOK_ID,
    HEYGEN_STUDENT_AVATAR_LOOK_ID: process.env.HEYGEN_STUDENT_AVATAR_LOOK_ID,
